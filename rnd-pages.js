    ...
    Planejamento: (appState) => {
        ...
        UIRenderer.updateDOM('main-content', `
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2"><button data-action="openModal" data-modal="modal-agendamento" class="bg-brand-medium text-white px-5 py-2.5 rounded-[12px] text-sm font-bold shadow-brand-glow"><i class="fa-solid fa-plus mr-2"></i> Novo lançamento futuro</button><button data-action="openModal" data-modal="modal-meta" class="bg-surface border border-brand-medium text-brand-medium px-5 py-2.5 rounded-[12px] text-sm font-bold"><i class="fa-solid fa-bullseye mr-2"></i> Criar meta</button></div>
            </div>
            ...
            <details class="bg-surface border border-border rounded-[16px] shadow-soft group mt-6" open><summary class="cursor-pointer list-none p-5 flex items-center justify-between font-bold text-text-primary">   <span><i class="fa-solid fa-chart-pie text-brand-medium mr-2"></i>Orçamento mensal</span><div class="flex items-center gap-3"><button data-action="openModal" data-modal="modal-orcamento" <button data-action="openModal" data-modal="modal-orcamento" class="bg-brand-medium text-white px-3 py-1.5 rounded-lg text-xs font-bold">Definir limite</button><i class="fa-solid fa-chevron-down group-open:rotate-180 transition-transform"></i></div></summary><div class="px-5 pb-5">${Components.budgetView(db.orcamentos, db.transacoes, appState)}</div></details>
            <details class="bg-surface border border-border rounded-[16px] shadow-soft group mt-4"><summary class="cursor-pointer list-none p-5 flex items-center justify-between font-bold text-text-primary"><span><i class="fa-solid fa-bullseye text-brand-medium mr-2"></i>Metas e reservas</span><i class="fa-solid fa-chevron-down group-open:rotate-180 transition-transform"></i></summary><div class="px-5 pb-5">${Components.goalsPage(db.metas, db.transacoes)}</div></details>
        `);
    },
